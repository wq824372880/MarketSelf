package com.zeekrlife.common.util.decoration;
...
//    }
    ...
    public enum DividerType {
        ...
        GRID_HORIZONTAL,
        /**
         * staggered grid vertical
         */
        STAGGERED_GRID_VERTICAL,
        /**
         * staggered grid horizontal
         */
     ...
     * dp转px
     */
    public static int dp2px(Context mContext , final float dpValue) {
     ...
     * px转dp
     */
    public static int px2dp(Context mContext , final float pxValue) {
        final float scale = mContext.getResources().getDisplayMetrics().density;
     ...
     * sp转px
     */
    public static int sp2px(Context mContext , final float spValue) {
     ...
     * px转sp
     */
    public static int px2sp(Context mContext , final float pxValue) {
        final float fontScale = mContext.getResources().getDisplayMetrics().scaledDensity;
     ...
     * @return
     */
    public static float applyDimension(Context mContext , final float value, final int unit) {
