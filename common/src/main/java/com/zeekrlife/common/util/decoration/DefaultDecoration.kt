...
import com.zeekrlife.common.util.decoration.DefaultDecoration.Edge.Companion.computeEdge
        ...
        when (orientation) {
            ...
            DividerOrientation.GRID -> {
                ...
                val bottom = when {
                    ...
                    startVisible && orientation == RecyclerView.VERTICAL -> if (spanGroupIndex == 0) height else 0
