...
public final class ActivityUtils {
    ...
    private static Activity getActivityFromDecorContext(Context context) {
        ...
        String decorContext = "com.android.internal.policy.DecorContext";
        if (decorContext.equals(context.getClass().getName())) {
            try {
    ...
    public static boolean isActivityExists(@NonNull final String pkg,
        ...
        PackageManager pm = Common.app.getPackageManager();
    ...
    public static void startActivityForResult(@NonNull final Fragment fragment,
                                              @NonNull final Class<? extends Activity> clz,
                                              final int requestCode) {
        startActivityForResult(fragment, null, Common.app.getPackageName(), clz.getName(),
                requestCode, null);
    }
    ...
    public static void startActivityForResult(@NonNull final Bundle extras,
                                              ...
                                              @NonNull final Class<? extends Activity> clz,
                                              final int requestCode) {
        startActivityForResult(fragment, extras, Common.app.getPackageName(), clz.getName(),
                requestCode, null);
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(Common.app.getPackageName());
    }
    ...
    public static String getLauncherActivity(@NonNull final String pkg) {
        ...
        Log.e("zzzTaskLayout","List<ResolveInfo>::" + info);
    ...
    public static List<String> getMainActivities() {
        return getMainActivities(Common.app.getPackageName());
    }
    ...
    public static Drawable getActivityIcon(@NonNull final Class<? extends Activity> clz) {
        return getActivityIcon(new ComponentName(Common.app, clz));
    }
    ...
    public static Drawable getActivityLogo(@NonNull final Class<? extends Activity> clz) {
        return getActivityLogo(new ComponentName(Common.app, clz));
    }
    ...
    private static boolean startActivity(final Intent intent,
        ...
        if (!isIntentAvailable(intent)) {
            XLog.INSTANCE.e("ActivityUtils", "intent is unavailable");
            return false;
        }
        if (!(context instanceof Activity)) {
    ...
    private static boolean startActivityForResult(final Intent intent,
        ...
        if (fragment.getActivity() == null) {
            XLog.INSTANCE.e("ActivityUtils", "Fragment " + fragment + " not attached to Activity");
            return false;
        }
        if (options != null && Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
