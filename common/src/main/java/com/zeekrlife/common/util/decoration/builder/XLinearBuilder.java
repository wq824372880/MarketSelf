...
import com.zeekrlife.common.util.decoration.decoration.ILDecoration;
import com.zeekrlife.common.util.decoration.decoration.LDecoration;
...
public final class XLinearBuilder extends XDividerDecoration.Builder implements ILDecoration {
     ...
     * 默认分割线的宽（高）度,单位像素px
     */
    private int mSpacing = DividerHelper.dp2px(mContext,1);
    /**
     * 是否绘制最后一条分割线
     */
    ...
    public XLinearBuilder setSpacing(float dpValueSpanSpace) {
        mSpacing = (int) DividerHelper.applyDimension(mContext,dpValueSpanSpace, TypedValue.COMPLEX_UNIT_DIP);
        return this;
    }
    ...
    public XLinearBuilder setSpacing(@DimenRes int dimenResId) {
        mSpacing = mContext.getResources().getDimensionPixelSize(dimenResId);
        return this;
    }
    ...
    public XLinearBuilder setLeftPadding(float dpValuePadding) {
        mLeftPadding = (int) DividerHelper.applyDimension(mContext,dpValuePadding, TypedValue.COMPLEX_UNIT_DIP);
        return this;
    }
    ...
    public XLinearBuilder setRightPadding(float dpValuePadding) {
        mRightPadding = (int) DividerHelper.applyDimension(mContext,dpValuePadding, TypedValue.COMPLEX_UNIT_DIP);
        return this;
    }
    ...
    public XLinearBuilder setLeftPadding(@DimenRes int dimenResId) {
        mLeftPadding = mContext.getResources().getDimensionPixelSize(dimenResId);
        return this;
    }
    ...
    public XLinearBuilder setRightPadding(@DimenRes int dimenResId) {
        mRightPadding = mContext.getResources().getDimensionPixelSize(dimenResId);
        return this;
    }
    ...
    public XLinearBuilder setTopPadding(float dpValuePadding) {
        mTopPadding = (int) DividerHelper.applyDimension(mContext,dpValuePadding, TypedValue.COMPLEX_UNIT_DIP);
        return this;
    }
    ...
    public XLinearBuilder setBottomPadding(float dpValuePadding) {
        mBottomPadding = (int) DividerHelper.applyDimension(mContext,dpValuePadding, TypedValue.COMPLEX_UNIT_DIP);
        return this;
    }
    ...
    public XLinearBuilder setTopPadding(@DimenRes int dimenResId) {
        mTopPadding = mContext.getResources().getDimensionPixelSize(dimenResId);
        return this;
    }
    ...
    public XLinearBuilder setBottomPadding(@DimenRes int dimenResId) {
        mBottomPadding = mContext.getResources().getDimensionPixelSize(dimenResId);
        return this;
    }
