...
object XLog {
    ...
    private fun wrapperContent(
        ...
        if(targetElement == null ||  targetElement.className.isNullOrEmpty() || targetElement.fileName.isNullOrEmpty()
            || targetElement.methodName.isNullOrEmpty() || targetElement.lineNumber < 0){
            return arrayOf(tagStr,"targetElement is null","targetElement is null")
        }
        targetElement.let {
