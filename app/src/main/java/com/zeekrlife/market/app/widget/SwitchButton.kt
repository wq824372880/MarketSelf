...
class SwitchButton @JvmOverloads constructor(
    ...
    /**
     * 该函数是Kotlin中的一个函数示例，用于在视图大小发生变化时被调用。函数的四个参数分别为新宽度、新高度、旧宽度和旧高度。在函数体内部，可以编写相应的代码来处理视图大小变化后的逻辑，例如重新布局或更新视图内容等
     */
    ...
    /**
     * 该函数是Kotlin中的一个函数示例，用于计算背景路径。函数接收一个参数percent，表示当前进度百分比。函数根据当前进度百分比计算出背景路径，并返回计算结果。
     *
    ...
    /**
     * 该函数是Kotlin中的一个函数示例，用于计算背景路径的平移量。函数接收一个参数percent，表示当前进度百分比。函数根据当前进度百分比计算出背景路径的平移量，并返回计算结果。
     */
    ...
    /**
     * 该函数是Kotlin中的一个函数示例，用于绘制背景路径。函数接收一个参数canvas，表示画布。函数根据当前状态绘制背景路径，并返回绘制结果。
     */
    ...
    /**
     * 该函数是Kotlin中的一个函数示例，用于设置开关的状态。函数接收一个参数checked，表示开关的状态。函数根据开关的状态设置不同的状态值，并返回设置结果。
     */
