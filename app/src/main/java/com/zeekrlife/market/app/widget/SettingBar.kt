    ...
    init {
        ...
        setLeftTextColor(
            array.getColor(
                ...
                ContextCompat.getColor(getContext(), R.color.colorBlackGry3)
            )
        )
        setRightTextColor(
            array.getColor(
                R.styleable.SettingBar_bar_rightTextColor,
                ContextCompat.getColor(getContext(), R.color.colorBlackGry6)
            )
        )
        ...
        if (background == null) {
            ...
            drawable.addState(
                ...
                ColorDrawable(ContextCompat.getColor(getContext(), R.color.color_f5f5f5))
            )
            drawable.addState(
            ...
            drawable.addState(
                intArrayOf(),
                ColorDrawable(ContextCompat.getColor(getContext(), R.color.colorWhite))
            )
            background = drawable
