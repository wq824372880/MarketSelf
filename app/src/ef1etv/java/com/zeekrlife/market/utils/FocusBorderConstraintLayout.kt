...
class FocusBorderConstraintLayout @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) :
    ...
    private val mFocusBorderDrawable: ZeekrTVFocusedBorderDrawable by lazy {
        ZeekrTVFocusedBorderDrawable(this@FocusBorderConstraintLayout)
    }
