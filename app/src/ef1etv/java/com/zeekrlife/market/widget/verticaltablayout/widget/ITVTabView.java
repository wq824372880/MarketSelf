...
public interface ITVTabView {

    ITVTabView setBadge(TabBadge badge);

    ITVTabView setIcon(TabIcon icon);

    ITVTabView setTitle(TabTitle title);

    ITVTabView setBackground(int resid);
    ...
    class TabIcon {
        ...
        public Drawable getNormalDrawable() {
            return mBuilder.mNormalDrawable;
        }
        ...
        public static class Builder {
            ...
            public Builder setIcon(Drawable normalDrawable) {
    ...
    class TabTitle {
        ...
        public int getTitleStyle() {
            return mBuilder.mTitleTextStyle;
        }
        ...
        public String getImageUrl() {
            return mBuilder.mImageUrl;
        }

        public int getImageWidth() {
            return mBuilder.mImageWidth;
        }

        public int getMarginLeft() {
            return mBuilder.mLeftMargin;
        }
