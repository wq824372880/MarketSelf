...
import com.zeekrlife.market.ui.viewmodel.AppDetailCXModel
 ...
 */
class AppDetailCXActivity : BaseActivity<AppDetailCXModel, ActivityAppDetailBinding>() {
    ...
    companion object {
         ...
         * 启动App详情页的Activity。
         *
         * @param activity 当前的Activity实例，可以为null。如果非null，将从这个Activity启动新的Activity。
         * @param appVersionId 应用版本的ID，用来在新启动的Activity中展示特定版本的详情。
         */
        fun start(activity: Activity?, appVersionId: Long) {
            // 使用提供的activity启动AppDetailCXActivity，并通过bundle传递参数
            toStartActivity(activity, AppDetailCXActivity::class.java, Bundle().apply {
        ...
        fun startByPackageName(activity: Activity?, packageName: String) {
            // 使用深链接方式启动AppDetailCXActivity，并传递包名和其他参数
            deepLinkToStartActivity(activity, AppDetailCXActivity::class.java, Bundle().apply {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        "AppDetailCXActivity onCreate".logE("AppDetailCXActivity")
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        imagesAdapter.setOnItemClickListener { _, _, position ->
            AppDetailImgPreviewCXActivity.start(
                this,
                position,
        ...
        mBind.layoutAppDetailInfo.tvPrivacyPolicyValue.setOnClickListener {
            ...
            if (!privacyPolicy.isNullOrEmpty() && Utils.isHttpUrl(privacyPolicy)) {
                toStartActivity(this, WebCXActivity::class.java, Bundle().apply {
...
//        }
            ...
            mBind.layoutAppDetailInfo.apply {
                ...
                ivAppDetailDescCheckAll.visibility = if (tvAppDetailDescEllipsisCount > 0) {
                    ...
                    layoutAppDetailDesc.setOnClickListener {
                        com.zeekr.component.dialog.ZeekrDialogCreate(this@AppDetailCXActivity)
                            .show {
                                title(getString(R.string.app_detail_introduce))
                                content(app.appDesc.ifEmptySetDef())
                                mediumSize()
                                lifecycleOwner(this@AppDetailCXActivity)
    ...
    override fun onLoadRetry() {
        ...
        showSuccessUi() // 显示成功UI的通用操作，此处具体操作未给出，可能包括隐藏错误信息、准备数据等
    ...
    override fun onStop() {
        super.onStop()
        "AppDetailCXActivity onStop".logE("AppDetailCXActivity")
    }

    override fun onDestroy() {
        super.onDestroy()
        "AppDetailCXActivity onDestroy".logE("AppDetailCXActivity")
    }
}
